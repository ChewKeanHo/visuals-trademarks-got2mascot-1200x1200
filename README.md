# Google's Go Programming Language (Go) T2 Mascot Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Go's T2 Mascot Trademarks Logo. They published a full and clear guideline
for deployment and did not supply the material files for it. The preferred
version is `.svg` which has non-destructive scale up & down properties and can
be converted into any rasterized images (e.g. `jpeg`, `webp`, `avif`, etc).
Hence, a re-draw is required.

This project re-draws Go's T2 Mascot Trademarks Logo specifically for 1200x1200
size.
...
Please read through Go's Trademark Engineering Specification
(https://go.dev/brand) before editing to avoid any unwanted legal implications.

While not specified by Go, please ensure the outputs are also web ready. Refer:
...
```
--------------------------------------------------------------------------------
Title: Google's Go Programming Language (Go) T2 Mascot Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-got2mascot-1200x1200
UUID: 0439FD53-264F-4234-AFFD-95CA8851D352
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-03
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-got2mascot-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH GOOGLE'S GO TRADEMARK REQUIREMENTS (Read: https://go.dev/brand)**.
>
